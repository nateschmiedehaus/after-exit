...
- `standards/` brand and editorial standards
- `archive/` template note
...
1. Make the business case with real market and media-space research.
2. Define differentiators against magazines, founder media, and executive communities.
3. Build a highly visual launch surface that feels like a serious editorial brand, not a memo.
